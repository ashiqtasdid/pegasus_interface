...
const ChatInterface: React.FC = () => {
  const { loadPlugins, plugins } = useUserPlugins();
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {plugins.map((pluginName: string) => (
              ...
              >
                <h4 className="font-semibold text-[var(--foreground)] mb-2">{pluginName}</h4>
                <p className="text-sm text-[var(--muted-foreground)] mb-3 line-clamp-2">
                  Minecraft plugin generated by AI
                </p>
